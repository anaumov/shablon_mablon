...
class SMSC
	...
	SMSC_LOGIN = Settings.smsc.login			# логин клиента
	SMSC_PASSWORD = Settings.smsc.password	# пароль или MD5-хеш пароля в нижнем регистре
	...
	SMTP_FROM = "maxim@actie.ru"		# e-mail адрес отправителя
